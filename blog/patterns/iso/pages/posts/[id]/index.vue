...
async function createComment() {
  await $fetch(`/api/posts/${route.params.id}/comments`, { method: "POST", body: comment })
...
<template>
  <div class="container">
    <header class="post-header">
      ...
      <NuxtLink class="button" :to="`/categories/${post.categoryid}`">
        #{{ post.category }}
      </NuxtLink>
      ...
      <div class="actions">
        <NuxtLink class="button" :to="`/posts/${$route.params.id}/edit`">Edit post</NuxtLink>
